...
export function FeaturesSection() {
  return (
    <section aria-labelledby="features-heading" className="relative" id="features">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-32 -left-20 z-0 h-[12rem] w-[12rem] rounded-full bg-gradient-to-br from-emerald-500/12 to-teal-400/8 blur-[90px] md:h-[18rem] md:w-[18rem]"></div>
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-20 -bottom-32 z-0 h-[10rem] w-[10rem] rounded-full bg-gradient-to-tl from-amber-500/10 to-yellow-400/6 blur-[100px] md:h-[16rem] md:w-[16rem]"></div>
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-40 right-1/3 z-0 h-[8rem] w-[8rem] rounded-full bg-gradient-to-r from-lime-400/5 to-green-400/4 blur-[80px] md:h-[14rem] md:w-[14rem]"></div>
