...
<MermaidDiagram chart={`flowchart TD
    ...
    subgraph UI["UI Layer"]
        Registry["@gentleduck/registry-ui\n59+ production components"]
    end
...
Every component in the `registry-ui` package is built on these primitives. If you want to build your own design system, start here.
